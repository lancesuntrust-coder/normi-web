...
export function TopControls() {
  return (
    <>
      {/* Top-left wordmark aligned to the top controls baseline */}
      <motion.div
      ...
      >
        ...
        <Link
          ...
          style={{ background: "var(--glass-overlay)", backdropFilter: "blur(32px)", borderColor: "var(--glass-border)", color: "rgba(255,255,255,0.85)" }}
        >
          Login
        </Link>
        <Link
          ...
          style={{ background: "var(--on-brand)", color: "var(--brand-coral-strong)" }}
        >
          Sign up
        </Link>
      </motion.nav>
